            ...
            <nav className="bg-blue-950 py-2 md:py-4">
                ...
                <div className="container px-4 mx-auto md:flex md:items-center">
                    ...
                    <div className="hidden md:flex flex-col md:flex-row md:ml-auto mt-3 md:mt-0" id="navbar-collapse">
                        ...
                        {/* <Link to="/login" >
                            <a href="#" className="p-2 lg:px-4 md:mx-2 text-white text-center border border-transparent rounded hover:bg-sky-800 hover:text-white transition-colors duration-300">Login</a>
                        </Link>
                        <Link to="signup">
                            <a href="#" className="p-2 lg:px-4 md:mx-2 text-white text-center border border-solid border-transparent rounded hover:bg-sky-800 hover:text-white transition-colors duration-300 mt-1 md:mt-0 md:ml-1">Signup</a>
                        </Link> */}
                    </div>
                </div>
            </nav>
