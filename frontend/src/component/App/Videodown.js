...
const Videodown = () => {
    ...
    //     const videoUrl = 'https://jmp.sh/TeM5LUrC';
    //     try {
    ...
    return (
        <>
            ...
            <a
                onClick={onDownload}
                className=" flex p-1 md:mx-2 text-white text-center border border-solid border-transparent rounded hover:bg-sky-800 hover:text-white transition-colors duration-300 mt-1 md:mt-0 md:ml-1"
            >
