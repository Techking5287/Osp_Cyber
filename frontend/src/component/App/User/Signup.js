            ...
            <div className='bg-gray-800 flex flex-col justify-center cursor-pointer'>
                <div className='max-w-[500px] w-full mx-auto rounded-lg bg-gray-900 p-8 px-8'>
                    ...
                    <div className='flex flex-col text-gray-400 py-2'>
                        ...
                        <input className='rounded-lg bg-gray-700 mt-2 p-2 focus:border-blue-500 focus:bg-gray-800 focus:outline-none' type="text" placeholder="  Enter your full name" />
                    </div>
                    <div className='flex flex-col text-gray-400 py-2'>
                    ...
                    <div className='flex flex-col text-gray-400 py-2'>
                        ...
                        <input className='p-2 rounded-lg bg-gray-700 mt-2 focus:border-blue-500 focus:bg-gray-800 focus:outline-none' type="password" placeholder="  Confirm your password" />
                    </div>
                    <div className='flex justify-between text-gray-400 py-2'>
                        <p className='flex items-center'><input className='mr-2' type="checkbox" /> Remember Me</p>
                    </div>
                    <button className='w-full my-5 py-2 bg-teal-500 shadow-lg shadow-teal-500/50 hover:shadow-teal-500/40 text-white font-semibold rounded-lg'>SIGNUP</button>
                </div>
            </div>
        </div>
